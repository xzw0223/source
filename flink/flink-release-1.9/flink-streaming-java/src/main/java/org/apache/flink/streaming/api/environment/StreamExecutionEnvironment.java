...
public abstract class StreamExecutionEnvironment {
	...
	*/
	...
	public static StreamExecutionEnvironment getExecutionEnvironment() {
		Optional<StreamExecutionEnvironmentFactory> streamExecutionEnvironmentFactory =
			Utils.resolveFactory(threadLocalContextEnvironmentFactory, contextEnvironmentFactory);
		return streamExecutionEnvironmentFactory
