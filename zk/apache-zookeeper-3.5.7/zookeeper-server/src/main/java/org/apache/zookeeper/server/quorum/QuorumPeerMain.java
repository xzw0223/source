...
public class QuorumPeerMain {
        ...
        throws ConfigException, IOException, AdminServerException
    {
        ...
        // 启动定时任务,用于清除快照的 , 如果清除间隔=0 则默认为关闭
      ...
      try {
          ...
          ServerCnxnFactory secureCnxnFactory = null;
            ...
            *serverCnxnFactory* :
             ...
             zookeeperAdmin.md 中介绍
             */
          if (config.getClientPortAddress() != null) {
              // 获取一个nio serverFactory      ->  // NIOServerCnxnFactory
              cnxnFactory = ServerCnxnFactory.createFactory();
              // 在这里创建 初始化了一个ServerSocketChannel
          ...
          // 创建了一个 QuorumPeer extends ZooKeeperThread(implement Thread)
